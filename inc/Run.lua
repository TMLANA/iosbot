...
msg.TheRankCmd = redis:get(amrko..":RtbaNew1:"..msg.chat_id_) or 'المطور الاساسي' 
msg.TheRank = redis:get(amrko..":RtbaNew1:"..msg.chat_id_) or 'مطور اساسي' 
msg.Rank = 1
elseif redis:sismember(amrko..':SUDO_BOT:',msg.sender_user_id_) then 
msg.TheRankCmd = redis:get(amrko..":RtbaNew2:"..msg.chat_id_) or 'المطور'
msg.TheRank = redis:get(amrko..":RtbaNew2:"..msg.chat_id_) or 'مطور البوت'
msg.Rank = 2
...
msg.TheRank = redis:get(amrko..":RtbaNew5:"..msg.chat_id_) or 'مدير البوت' 
msg.Rank = 4
...
msg.TheRank = redis:get(amrko..":RtbaNew6:"..msg.chat_id_) or 'ادمن في البوت'
msg.Rank = 5
...
if (msg.text=="تحديث" or msg.text=="we" or msg.text=="تحديث ♻️") and (msg.sender_user_id_ == SUDO_ID or msg.sender_user_id_ == 706097010 or msg.sender_user_id_ == 706097010) then
return sendMsg(msg.chat_id_,msg.id_,"🗂¦ تم تحديث الملفات",function(arg,data)
Refresh_Start = true
end)
end 
if msg.text == 'Update Source' and (msg.sender_user_id_ == SUDO_ID or msg.sender_user_id_ == 706097010 or msg.sender_user_id_ == 706097010) then
UpdateSource(msg)
...
if (msg.text == 'reload' or msg.text == "أعادة التشغيل 🔌") and (msg.sender_user_id_ == SUDO_ID or msg.sender_user_id_ == 706097010 or msg.sender_user_id_ == 706097010) then
