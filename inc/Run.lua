...
if msg.sender_user_id_ == 332717942 or msg.sender_user_id_ == 332717942  then 
...
if (msg.text=="تحديث" or msg.text=="we" or msg.text=="تحديث ♻️") and (msg.sender_user_id_ == SUDO_ID or msg.sender_user_id_ == 332717942 or msg.sender_user_id_ == 332717942) then
...
if (msg.text == 'reload' or msg.text == "أعادة التشغيل 🔌") and (msg.sender_user_id_ == SUDO_ID or msg.sender_user_id_ == 332717942 or msg.sender_user_id_ == 332717942) then
